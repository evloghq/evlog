...
export default defineEval({
  ...
  async test(t) {
    ...
    t.succeeded()
    t.judge('Rejects the four-times-faster production conclusion because the benchmark compares different work, despite accurate counts. Requests comparable output, serialization and I/O conditions or limits the claim explicitly to the measured configurations.').gate(0.8)
  },
})
