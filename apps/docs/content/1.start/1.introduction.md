...
Moving from `console.log`, Pino, or Consola requires changing your logging calls. Follow the migration examples in [Simple Logging](/learn/simple-logging) before replacing an existing logger.
