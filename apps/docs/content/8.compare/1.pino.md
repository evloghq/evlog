...
Inventory the fields your dashboards query, custom levels, serializers, and transport configuration. Map them explicitly before switching output. Pino serializers do not transfer unchanged into evlog [plugins](/extend/plugins), and a custom transport may need a new [drain](/extend/drain-pipeline).
