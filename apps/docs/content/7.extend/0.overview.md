...
Shipping a library or SDK that emits events, rather than a drain or an integration? [Libraries](/libraries/overview) covers the contract library authors follow: emit without owning the configuration, attribute your events, throw catalog errors.
