...
Each of these is a property of [the stream](/extend/stream), not of your consumer: one in-process bus, one SSE bridge, and a ring buffer that replays but never persists to disk.
