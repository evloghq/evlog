...
A catalog is just regular TypeScript that depends on `evlog` as a peer dep. Here is the minimal recipe. For the logging side of shipping evlog from a package, [Libraries](/libraries/errors) covers emitting without owning the configuration, attributing events to your package, and what error codes owe your consumers.
