...
Shipping evlog inside an npm library or SDK instead? [Libraries](/libraries/overview) covers what a package may emit and what it leaves to the host application.
::
